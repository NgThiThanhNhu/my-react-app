...
const BookCategory =()=>{
        ...
        const fetchbookCategories = async()=>{
         try{
             ...
             if(response.data && Array.isArray(response.data)){
                 ...
                 setBookCategories(response.data); //cập nhật usestate
             }else 
             {
    ...
    const handleSubmit = async(e)=>{
        ...
        try{
            ...
            if(response.data.id){
                ...
                alert('Thêm categoryName thành công!'+ response.data.name);
                setBookCategories(prev => [...prev, response.data]); 
    ...
    const handleGetBookCategoryById = async(e)=>{
        ...
        try{
            ...
            if(response.data.id == bookCategoryId){
    ...
    const  handleUpdateCategory =async(e)=>{
        ...
        if (response.isSuccess) {
            const updatedCategory = response.data.name;
